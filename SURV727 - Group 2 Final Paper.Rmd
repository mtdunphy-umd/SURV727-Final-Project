...
Since 2010 and the controversial decision of Citizens United vs. FEC, the amount of money spent on political campaigns has risen exponentially. In 2010, a midterm election where infamously Republicans picked up a half dozen seats in the Senate and more than 60 seats in the House, political expenditures totaled around 3.6B. In 2022, that number is projected to be around $8.9B. (https://www.opensecrets.org/elections-overview/cost-of-election?cycle=2020&display=T&infl=N)
...
Major partisan events that dominate the greater political discussion often cause a mass influx of capital to political campaigns. With each fundraising cycle there are candidates that perform worse or better based on candidate quality and the overall political climate. Our goal is to identify those trends in contributions that correlate with significant political shocks during the 2022 midterm cycle, as well as identify characteristics of candidates that affected fundraising performance. In our analysis, we build a linear model to identify those candidates that were above or below fundraising expectations - controlling for the characteristics of candidates and their districts. We conduct principal component analysis to identify which variables are the most predictive for our model. We also utilize data visualizations such as highest fundraising performance by party and office and plotting fundraising numbers over time through the 2022 election cycle.
...
```
Fig. 8 shows the 15 highest Democratic fundraisers running for the House in the 2022 Midterms. Most of the candidates were in competitive districts - which explains the wider gap in fundraising by party in competitive districts in Fig 7. Katie Porter (CA-45), the highest fundraiser on this visual, is one of the most well known members of the Democratic caucus. She has a strong national presence and a strong social media following - she also was in a competitive race with a pro-life Republican candidate (https://www.latimes.com/politics/story/2022-10-20/2022-california-midterm-election-porter-baugh-abortion-economy-environment). 4 out of the 15 candidates shown narrowly lost their race. 
...
```
Fig. 9 shows the 15 highest Democratic fundraisers running for Senate in the 2022 Midterm Election. This graph shows almost exclusively senate seats that were at least slightly competitive. 5 out of the 15 candidates lost their election - most notably the 3rd highest fundraiser Val Demmings losing by 16 points to Marco Rubio.  Meanwhile Mandala Barnes, the Democratic challenger in Wisconsin, lost by just 1 point, despite his opponent Ron Johnson being the highest Republican fundraiser (Fig 10). Each senate election by state has different factors that influence not only how much money comes in - but how effective it is in effecting the final vote count.
